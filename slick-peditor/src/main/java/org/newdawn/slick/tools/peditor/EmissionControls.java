...
public class EmissionControls extends ControlPanel {
    ...
    public EmissionControls() {
        ...
        addMinMax("spawnInterval", new MinMaxPanel("Spawn Interval (ms)", 1, 100000, 100, 100,
                "The interval between the production of particles"));
        addMinMax("spawnCount", new MinMaxPanel("Spawn Count (# of particles)", 1, 100, 1, 1,
                "The number of particles created each spawn"));
