...
public class LimitPanel extends ControlPanel {
    ...
    public LimitPanel(EmitterList l) {
        ...
        lengthPanel = new MinMaxPanel("Effect Length", 0, 100000, 1000, 1000, true, -1,
                "The length the effect will last");
        addMinMax("length", lengthPanel);
        emitCountPanel = new MinMaxPanel("Particle Emission Count", 0, 100000, 1000, 1000, true, -1,
                "The number of particles that will be emitted during the effect");
    ...
    /**
     * @see ControlPanel#minMaxUpdated(MinMaxPanel)
     */
