...
public class WhiskasPanel extends ControlPanel {
     ...
     * @param colorPanel       The panel controlling the colours that needs to be controlled based on the enablement
     *                         here
    ...
    public WhiskasPanel(EmitterList l, final ColorPanel colorPanel, final EmissionControls emissionControls) {
        ...
        addEnableControl("Alpha", new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                colorPanel.getStartAlpha().setEnabled(e.getStateChange() != ItemEvent.SELECTED);
                colorPanel.getEndAlpha().setEnabled(e.getStateChange() != ItemEvent.SELECTED);
        ...
        addEnableControl("Size", new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                emissionControls.getInitialSize().setEnabledForced(e.getStateChange() != ItemEvent.SELECTED);
                itemStateChangedHandler(e);
            }
