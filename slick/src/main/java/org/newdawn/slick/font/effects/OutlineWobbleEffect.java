...
public class OutlineWobbleEffect extends OutlineEffect {
    ...
    public List getValues() {
        ...
        values.add(EffectUtil.floatValue("Detail", detail, 1, 50, "This setting controls how detailed the outline " +
                "will be. " + "Smaller numbers cause the outline to have more detail."));
