...
public class GradientEffect implements ConfigurableEffect {
    ...
    public List getValues() {
        ...
        values.add(EffectUtil.intValue("Offset", offset, "This setting allows you to move the gradient up or down. "
                + "The gradient is normally centered on the glyph."));
        values.add(EffectUtil.floatValue("Scale", scale, 0, 1, "This setting allows you to change the height of the " +
                "gradient by a" + "percentage. The gradient is normally the height of most glyphs in the font."));
