...
/**
 * An effect that has a number of configuration values. This allows the effect to be configured in the Hiero GUI and to
 * be saved and loaded to and from a file.
 * <p>
