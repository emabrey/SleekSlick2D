...
public class ParticleIO {
     ...
     * @throws IOException Indicates a failure to find, read or parse the XML file
     */
    public static ParticleSystem loadConfiguredSystem(String ref, ConfigurableEmitterFactory factory) throws
            IOException {
     ...
     * @throws IOException Indicates a failure to find, read or parse the XML file
     */
    public static ParticleSystem loadConfiguredSystem(InputStream ref, ConfigurableEmitterFactory factory) throws
            IOException {
    ...
    public static ParticleSystem loadConfiguredSystem(InputStream ref, ConfigurableEmitterFactory factory,
                                                      ParticleSystem system, Color mask) throws IOException {
        if (factory == null) {
     ...
     * @throws IOException Indicates a failure to find, read or parse the XML file
     */
    public static ConfigurableEmitter loadEmitter(InputStream ref, ConfigurableEmitterFactory factory) throws
            IOException {
        if (factory == null) {
            factory = new ConfigurableEmitterFactory() {
                public ConfigurableEmitter createEmitter(String name) {
