...
/**
 * An emitter than can be externally configured. This configuration can also be saved/loaded using the ParticleIO
 * class.
 * <p/>
 *
 * @author kevin
...
public class ConfigurableEmitter implements ParticleEmitter {
    ...
    public void updateParticle(Particle particle, int delta) {
        ...
        particle.adjustVelocity(windFactor.getValue(0) * 0.00005f * delta, gravityFactor.getValue(0) * 0.00005f *
                delta);
