...
/**
 * An emitter is responsible for producing the particles and controlling them during their life. An implementation of
 * this interface can be considered a particle effect.
 * <p/>
 *
 * @author kevin
 */
public interface ParticleEmitter {
    ...
    /**
     * Wrap up the particle emitter. This means the emitter will no longer produce particles and will be marked as
     * completed once the particles have expired
     */
    public void wrapUp();
