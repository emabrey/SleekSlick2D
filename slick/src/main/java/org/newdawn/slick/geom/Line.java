...
/**
 * Implemenation of a bunch of maths functions to do with lines. Note that lines can't be used as dynamic shapes right
 * now - also collision with the end of a line is undefined.
 * <p/>
 *
 * @author Kevin Glass
 */
