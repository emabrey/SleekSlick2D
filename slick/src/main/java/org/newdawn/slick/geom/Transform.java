...
public class Transform {
    ...
    public Transform(float matrixPosition[]) {
        ...
        this.matrixPosition = new float[]{matrixPosition[0], matrixPosition[1], matrixPosition[2], matrixPosition[3],
    ...
    public void transform(float source[], int sourceOffset, float destination[], int destOffset, int numberOfPoints) {
        ...
        for (int i = 0; i < numberOfPoints * 2; i += 2) {
            for (int j = 0; j < 6; j += 3) {
                result[i + (j / 3)] = source[i + sourceOffset] * matrixPosition[j] + source[i + sourceOffset + 1] *
    ...
    public Transform concatenate(Transform tx) {
        ...
        float n02 = matrixPosition[0] * tx.matrixPosition[2] + matrixPosition[1] * tx.matrixPosition[5] +
                matrixPosition[2];
        ...
        float n12 = matrixPosition[3] * tx.matrixPosition[2] + matrixPosition[4] * tx.matrixPosition[5] +
                matrixPosition[5];
        mp[0] = n00;
        mp[1] = n01;
        mp[2] = n02;
        ...
        mp[5] = n12;
//    	
//        mp[0] = matrixPosition[0] * transform.matrixPosition[0] + matrixPosition[0] * transform.matrixPosition[3] +
// matrixPosition[0] * transform.matrixPosition[6];
//        mp[1] = matrixPosition[1] * transform.matrixPosition[1] + matrixPosition[1] * transform.matrixPosition[4] +
// matrixPosition[1] * transform.matrixPosition[7];
//        mp[2] = matrixPosition[2] * transform.matrixPosition[2] + matrixPosition[2] * transform.matrixPosition[5] +
// matrixPosition[2] * transform.matrixPosition[8];
//        mp[3] = matrixPosition[3] * transform.matrixPosition[0] + matrixPosition[3] * transform.matrixPosition[3] +
// matrixPosition[3] * transform.matrixPosition[6];
//        mp[4] = matrixPosition[4] * transform.matrixPosition[1] + matrixPosition[4] * transform.matrixPosition[4] +
// matrixPosition[4] * transform.matrixPosition[7];
//        mp[5] = matrixPosition[5] * transform.matrixPosition[2] + matrixPosition[5] * transform.matrixPosition[5] +
// matrixPosition[5] * transform.matrixPosition[8];
//        
        matrixPosition = mp;
        return this;
    }
    ...
    public String toString() {
        String result = "Transform[[" + matrixPosition[0] + "," + matrixPosition[1] + "," +
                "" + matrixPosition[2] + "][" + matrixPosition[3] + "," + matrixPosition[4] + "," +
                "" + matrixPosition[5] + "][" + matrixPosition[6] + "," + matrixPosition[7] + "," +
                "" + matrixPosition[8] + "]]";
    ...
    public static Transform createRotateTransform(float angle) {
        return new Transform((float) FastTrig.cos(angle), -(float) FastTrig.sin(angle), 0,
