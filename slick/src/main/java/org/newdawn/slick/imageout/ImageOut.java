...
/**
 * A static hook to access all the Image output utilities. The list of format strings provided is not the limit of
 * capability. These are provided for utility, use @see {@link #getSupportedFormats()} for a full list of supported
 * formats.
 * <p/>
 *
 * @author kevin
