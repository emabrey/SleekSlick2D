 ...
 * Expected usage:
 * <p/>
 * <code> SlickCallable callable = new SlickCallable() { public performGLOperations() throws SlickException {
 * GL.glTranslate(0,0,1); glBegin(GL.GL_POLYGONS); glVertex(..); ... glEnd(); } } callable.call(); </code>
 * <p/>
 * Alternatively you can use the static methods directly
 * <p/>
 * <code> SlickCallable.enterSafeBlock();
 * <p/>
 * GL.glTranslate(0,0,1); glBegin(GL.GL_POLYGONS); glVertex(..); ... glEnd();
 * <p/>
 * SlickCallable.leaveSafeBlock(); </code>
 * <p/>
 *
 * @author kevin
 */
