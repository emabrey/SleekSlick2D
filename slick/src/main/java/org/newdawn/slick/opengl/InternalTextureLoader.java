...
public class InternalTextureLoader {
     ...
     * @throws IOException Indicates a failure to load the image
     */
    public TextureImpl getTexture(InputStream in, String resourceName, boolean flipped, int filter,
        ...
        try {
            ...
            throw new RuntimeException("Image based resources must be loaded as part of init() or the game loop. They" +
                    " cannot be" + " loaded before initialisation.");
        }
     ...
     * @throws IOException Indicates a failure to load the image
     */
    private TextureImpl getTexture(InputStream in, String resourceName, int target, int magFilter, int minFilter,
        ...
        GL.glTexImage2D(target, 0, dstPixelFormat, get2Fold(width), get2Fold(height), 0, srcPixelFormat,
