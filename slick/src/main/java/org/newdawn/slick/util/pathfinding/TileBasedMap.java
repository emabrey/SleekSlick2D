...
/**
 * The description for the data we're pathfinding over. This provides the contract between the data being searched (i.e.
 * the in game map) and the path finding generic tools
 * <p/>
 *
 * @author Kevin Glass
 */
