...
public class FontUtils {
     ...
     */
    public static final int drawString(Font font, final String s, final int alignment, final int x, final int y,
                                       final int width, Color color) {
        ...
        if (alignment == Alignment.LEFT) {
            ...
            return FontUtils.drawJustifiedSpaceSeparatedSubstrings(font, s, x, y,
                    FontUtils.calculateWidthOfJustifiedSpaceInPixels(font, s, leftWidth));
        }
     ...
     */
    private static int drawJustifiedSpaceSeparatedSubstrings(Font font, final String s, final int x, final int y,
