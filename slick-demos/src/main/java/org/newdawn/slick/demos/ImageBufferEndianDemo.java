...
/**
 * Quick Demo for endianess in image buffers
 * <p/>
 *
 * @author thaaks
 */
public class ImageBufferEndianDemo extends BasicGame {
     ...
     * Create a new Demo
     */
    public ImageBufferEndianDemo() {
        super("ImageBuffer Endian Demo");
    }
     ...
     * <p/>
     *
     * @param args The arguments passed into the Demo
     */
    public static void main(String[] args) {
        try {
            AppGameContainer container = new AppGameContainer(new ImageBufferEndianDemo());
