...
/**
 * A simple graphics Demo for the context allowing vector based graphics
 * <p/>
 *
 * @author kevin
 */
public class GeomAccuracyDemo extends BasicGame {

    /**
     * The container holding this Demo
     */
     ...
     */
    public GeomAccuracyDemo() {
        super("Geometry Accuracy Demos");
    }
    ...
    public void render(GameContainer container, Graphics g) {
        ...
        g.drawString("Current Demo:", 400, 35);
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new GeomAccuracyDemo());
