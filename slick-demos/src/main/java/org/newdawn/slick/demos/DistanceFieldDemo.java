...
/**
 * A Demo to Demonstrate distance fields generated by Hiero being applied to scaled fonts
 * <p/>
 *
 * @author kevin
 */
public class DistanceFieldDemo extends BasicGame {
    ...
    public void init(GameContainer container) throws SlickException {
        font = new AngelCodeFont("org/newdawn/slick/testdata/distance.fnt", "org/newdawn/slick/testdata/distance-dis"
                + ".png");
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new DistanceFieldDemo());
