...
/**
 * A Demo to show nav-mesh generation on tile based maps.
 * <p/>
 *
 * @author kevin
 */
public class NavMeshDemo extends BasicGame implements PathFindingContext {
    ...
    private class DataMap implements TileBasedMap {
        ...
        /*
         * (non-Javadoc)
         * @see org.newdawn.slick.util.pathfinding.TileBasedMap#blocked(org.newdawn.slick.util.pathfinding
    ...
    public static void main(String[] argv) {
        Bootstrap.runAsApplication(new NavMeshDemo(), 600, 600, false);
    }
