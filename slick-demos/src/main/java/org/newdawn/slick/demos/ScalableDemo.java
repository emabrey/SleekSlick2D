...
/**
 * A Demo for a scalable game
 * <p/>
 *
 * @author kevin
 */
public class ScalableDemo extends BasicGame {

    /**
     * Simple Demo
     */
    public ScalableDemo() {
        super("Scalable Demo For Widescreen");
    }
    ...
    public static void main(String[] argv) {
        // normal res
//		try {
//			AppGameContainer container = new AppGameContainer(new ScalableGame(new InputDemo(),600,600));
...
//		// bigger
//		try {
//			AppGameContainer container = new AppGameContainer(new ScalableGame(new InputDemo(),600,600,true));
...
//		}
        ...
        try {
            ScalableGame game = new ScalableGame(new ScalableDemo(), 1024, 568, true) {
