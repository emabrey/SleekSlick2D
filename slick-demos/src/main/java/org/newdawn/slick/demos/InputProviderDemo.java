...
/**
 * A Demo for abstract input via InputProvider
 * <p/>
 *
 * @author kevin
 */
public class InputProviderDemo extends BasicGame implements InputProviderListener {
     ...
     */
    public InputProviderDemo() {
        super("InputProvider Demo");
    }
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new InputProviderDemo());
