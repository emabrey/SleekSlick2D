...
/**
 * A simple Demo state to display an image and rotate it
 * <p/>
 *
 * @author kevin
 */
public class DemoState3 extends BasicGameState {
    ...
    public void keyReleased(int key, char c) {
        ...
        if (key == Input.KEY_1) {
            game.enterState(DemoState1.ID, new FadeOutTransition(Color.black), new FadeInTransition(Color.black));
        }
        if (key == Input.KEY_2) {
            game.enterState(org.newdawn.slick.demos.states.DemoState2.ID, new FadeOutTransition(Color.black),
