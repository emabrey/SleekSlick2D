...
/**
 * A Demo for duplicating a ConfigurableEmitter several times
 * <p/>
 *
 * @author Tommy
 */
public class DuplicateEmitterDemo extends BasicGame {
    ...
    /**
     * Create a new DuplicateEmitterDemo
     */
    public DuplicateEmitterDemo() {
        super("DuplicateEmitterDemo");
    }
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new DuplicateEmitterDemo());
