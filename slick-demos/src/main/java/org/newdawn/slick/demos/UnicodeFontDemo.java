...
/**
 * A simple Demo of the unicode font functionality provided
 * <p/>
 *
 * @author Nathan Sweet <misc@n4te.com>
 */
public class UnicodeFontDemo extends BasicGame {

    /**
     * The font we're going to display in the Demo
     */
    private UnicodeFont unicodeFont;

    /**
     * Create the simple font Demo
     */
    public UnicodeFontDemo() {
        super("Font Demo");
    }
...
//		unicodeFont.getEffects().add(new ShadowEffect(java.awt.Color.black, 5, 5, 0.5f));
    ...
    public void render(GameContainer container, Graphics g) {
        ...
        // Cypriot Syllabary glyphs (Everson Mono font): \uD802\uDC02\uD802\uDC03\uD802\uDC12 == 0x10802, 0x10803,
        // s0x10812
     ...
     * <p/>
     *
     * @param args The arguments supplied to the Demo
     *             <p/>
     *
    ...
    public static void main(String[] args) throws SlickException, IOException {
        ...
        AppGameContainer container = new AppGameContainer(new UnicodeFontDemo());
