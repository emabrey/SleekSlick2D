 ...
 */
public class TrueTypeFontPerformanceDemo extends BasicGame {

    /**
     * The java.awt font we're going to Demo
     */
     ...
     */
    public TrueTypeFontPerformanceDemo() {
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new TrueTypeFontPerformanceDemo());
