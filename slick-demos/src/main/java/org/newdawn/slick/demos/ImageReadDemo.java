...
/**
 * A Demo for reading image data from a teture
 * <p/>
 *
 * @author kevin
 */
public class ImageReadDemo extends BasicGame {
    ...
    /**
     * Create a new image reading Demo
     */
    public ImageReadDemo() {
        super("Image Read Demo");
    }
    ...
    public void render(GameContainer container, Graphics g) {
        ...
        g.drawString("Move mouse over Demo image", 200, 20);
        g.setColor(read[0]);
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new ImageReadDemo());
