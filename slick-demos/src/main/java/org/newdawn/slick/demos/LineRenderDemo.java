...
/**
 * A Demo for the line rendering capability
 * <p/>
 *
 * @author kevin
 */
public class LineRenderDemo extends BasicGame {
     ...
     * Create a new Demo
     */
    public LineRenderDemo() {
        super("LineRenderDemo");
    }
...
//		g.draw(polygon);
    ...
    public static void main(String[] argv) {
        try {
            ...
            AppGameContainer container = new AppGameContainer(new LineRenderDemo());
