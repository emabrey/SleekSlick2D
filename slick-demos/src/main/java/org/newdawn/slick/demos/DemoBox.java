...
/**
 * A Demo box containing a bunch of tests that can be used for quickly sanity checking tests.
 * <p/>
 *
 * @author kevin
 */
public class DemoBox extends BasicGame {
     ...
     * <p/>
     *
     * @param game The game to add to the Demo box
     */
    ...
    public static void main(String[] argv) {
        try {
            ...
            box.addGame(AnimationDemo.class);
            box.addGame(org.newdawn.slick.demos.AntiAliasDemo.class);
            box.addGame(org.newdawn.slick.demos.BigImageDemo.class);
            box.addGame(org.newdawn.slick.demos.ClipDemo.class);
            box.addGame(org.newdawn.slick.demos.DuplicateEmitterDemo.class);
            box.addGame(org.newdawn.slick.demos.FlashDemo.class);
            box.addGame(org.newdawn.slick.demos.FontPerformanceDemo.class);
            box.addGame(FontDemo.class);
            box.addGame(org.newdawn.slick.demos.GeomDemo.class);
            box.addGame(org.newdawn.slick.demos.GradientDemo.class);
            box.addGame(org.newdawn.slick.demos.GraphicsDemo.class);
            box.addGame(org.newdawn.slick.demos.ImageBufferDemo.class);
            box.addGame(org.newdawn.slick.demos.ImageReadDemo.class);
            box.addGame(org.newdawn.slick.demos.ImageDemo.class);
            box.addGame(org.newdawn.slick.demos.KeyRepeatDemo.class);
            box.addGame(org.newdawn.slick.demos.MusicListenerDemo.class);
            box.addGame(org.newdawn.slick.demos.PackedSheetDemo.class);
            box.addGame(org.newdawn.slick.demos.PedigreeDemo.class);
            box.addGame(PureFontDemo.class);
            box.addGame(org.newdawn.slick.demos.ShapeDemo.class);
            box.addGame(org.newdawn.slick.demos.SoundDemo.class);
            box.addGame(org.newdawn.slick.demos.SpriteSheetFontDemo.class);
            box.addGame(org.newdawn.slick.demos.TransparentColorDemo.class);
