...
/**
 * A Demo for gradient fill on polygons
 * <p/>
 *
 * @author kevin
 */
public class GradientDemo extends BasicGame {
    ...
    public static void main(String[] argv) {
        try {
            ...
            AppGameContainer container = new AppGameContainer(new GradientDemo());
