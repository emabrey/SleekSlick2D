...
/**
 * A Demo for the AWT Canvas container
 * <p/>
 *
 * @author kevin
 */
public class CanvasContainerDemo extends BasicGame {
     ...
     */
    public CanvasContainerDemo() {
        super("Canvas Container Demo");
    }
    ...
    public static void main(String[] argv) {
        try {
            CanvasGameContainer container = new CanvasGameContainer(new CanvasContainerDemo());
