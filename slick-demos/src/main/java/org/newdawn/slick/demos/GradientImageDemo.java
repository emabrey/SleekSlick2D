...
/**
 * A Demo for applying gradients to images
 * <p/>
 *
 * @author kevin
 */
public class GradientImageDemo extends BasicGame {
     ...
     */
    public GradientImageDemo() {
        super("Gradient Image Demo");
    }
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new GradientImageDemo());
