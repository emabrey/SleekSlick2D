...
/**
 * A Demo for music listeners which notify you when the music has eneded
 * <p/>
 *
 * @author kevin
 */
public class MusicListenerDemo extends BasicGame implements MusicListener {
     ...
     * Create a new Demo
     */
    public MusicListenerDemo() {
        super("Music Listener Demo");
    }
    ...
    /**
     * Entry point to the sound Demo
     * <p/>
     *
     * @param argv The arguments provided to the Demo
     */
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new MusicListenerDemo());
