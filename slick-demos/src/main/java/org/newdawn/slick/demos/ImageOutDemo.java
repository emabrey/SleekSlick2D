...
/**
 * A Demo for saving images
 * <p/>
 *
 * @author kevin
 */
public class ImageOutDemo extends BasicGame {
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new ImageOutDemo());
