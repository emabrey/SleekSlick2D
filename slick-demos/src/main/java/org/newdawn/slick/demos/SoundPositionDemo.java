...
/**
 * A Demo for the sound system (positioning) of the library
 * <p/>
 *
 * @author kevin
 */
public class SoundPositionDemo extends BasicGame {
    ...
    /**
     * Create a new Demo for sounds
     */
    public SoundPositionDemo() {
        super("Music Position Demo");
    }
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new SoundPositionDemo());
