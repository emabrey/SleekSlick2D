...
/**
 * A simple Demo to show performance gains from cache operations in situtations where rendering is static and heavy
 * <p/>
 *
 * @author kevin
 */
public class CachedRenderDemo extends BasicGame {
    ...
    /**
     * Create a new simple Demo for cached rendering (aka display lists)
     */
    public CachedRenderDemo() {
        super("Cached Render Demo");
    }
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new CachedRenderDemo());
