...
/**
 * A Demo for the GUI components available in Slick. Very simple stuff
 * <p/>
 *
 * @author kevin
 */
public class GUIDemo extends BasicGame implements ComponentListener {
    ...
    /**
     * Create a new Demo of GUI rendering
     */
    public GUIDemo() {
        super("GUI Demo");
    }
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new GUIDemo());
