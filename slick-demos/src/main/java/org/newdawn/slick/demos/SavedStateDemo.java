...
/**
 * A Demo of the the local storage utilities
 * <p/>
 *
 * @author kevin
 */
public class SavedStateDemo extends BasicGame implements ComponentListener {
     ...
     */
    public SavedStateDemo() {
        super("Saved State Demo");
    }
    ...
    public static void main(String[] argv) {
        try {
            container = new AppGameContainer(new SavedStateDemo());
