...
/**
 * A Demo for transforming the graphics context
 * <p/>
 *
 * @author Jesse Aldridge
 */
public class TransformDemo2 extends BasicGame {
     ...
     */
    public TransformDemo2() {
        super("Transform Demo");
    }
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new TransformDemo2());
