...
/**
 * A Demo of the tile map system based around the TilED (http://www.mapeditor.org) tool
 * <p/>
 *
 * @author kevin
 */
public class TileMapDemo extends BasicGame {
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new TileMapDemo());
