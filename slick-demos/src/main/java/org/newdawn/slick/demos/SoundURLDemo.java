...
/**
 * A Demo for the sound system of the library
 * <p/>
 *
 * @author kevin
 * @author aaron
 */
public class SoundURLDemo extends BasicGame {
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new SoundURLDemo());
