...
/**
 * A Demo for rendering to an image
 * <p/>
 *
 * @author kevin
 */
public class ImageGraphicsDemo extends BasicGame {
    ...
    public void render(GameContainer container, Graphics g) throws SlickException {
        ...
        g.drawString("Demoing On Offscreen Buffer", 300, 80);
        ...
        // SCREEN COPY EXAMPLE
        // Put some text and simple graphics on the screen to Demo copying
        // from the screen to a target image
        g.setColor(Color.white);
        g.drawString("Demoing Font On Back Buffer", 10, 100);
    ...
    public static void main(String[] argv) {
        try {
            ...
            AppGameContainer container = new AppGameContainer(new ImageGraphicsDemo());
