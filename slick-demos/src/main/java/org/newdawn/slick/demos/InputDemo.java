 ...
 * @author kevin
 */
public class InputDemo extends BasicGame {
    ...
    public void render(GameContainer container, Graphics g) {
        ...
        g.drawString("Use the primary gamepad to control the blob, and hit a gamepad button to change the color", 10,
                90);
     ...
     * <p/>
     *
     * @param argv The arguments passed into our Demo
     */
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new InputDemo());
