...
/**
 * A Demo for packed sprite sheets
 * <p/>
 *
 * @author kevin
 */
public class PackedSheetDemo extends BasicGame {
     ...
     */
    public PackedSheetDemo() {
        super("Packed Sprite Sheet Demo");
    }
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new PackedSheetDemo());
