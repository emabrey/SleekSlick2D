...
public class DataSet {
    ...
    public void toAngelCodeText(PrintStream out, String imageName) {
        out.println("info face=\"" + fontName + "\" size=" + size + " bold=0 italic=0 charset=\"" + setName + "\" " +
                "unicode=0 stretchH=100 smooth=1 aa=1 padding=0,0,0,0 spacing=1,1");
        out.println("common lineHeight=" + lineHeight + " base=26 scaleW=" + width + " scaleH=" + height + " pages=1 " +
                "packed=0");
        ...
        for (int i = 0; i < chars.size(); i++) {
            ...
            out.println("char id=" + c.getID() + "   x=" + c.getX() + "     y=" + c.getY() + "     width=" + c
                    .getWidth() + "     height=" + c.getHeight() + "     xoffset=0     yoffset=" + c.getYOffset() + "" +
                    "    xadvance=" + c.getXAdvance() + "     page=0  chnl=0 ");
        }
